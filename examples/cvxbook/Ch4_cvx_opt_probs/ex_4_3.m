% EX_4_3.M    solves a simple QP with inequality constraints 
% Exercise 4.3, Boyd & Vandenberghe "Convex Optimization"
% Joëlle Skaf - 09/26/05
%
% Solves that the following QP with inequality constraints 
