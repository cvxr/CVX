...
u1 = u(u<a); m1 = length(u1);
u2 = u((u >= a) & (u<b));  m2 = length(u2);
u3 = u(u >= b);  m3 = length(u3);
...
cvx_begin
    ...
    [1 a a^2   a^3]*x1 == [1 a a^2   a^3]*x2; %#ok
    [0 1 2*a 3*a^2]*x1 == [0 1 2*a 3*a^2]*x2; %#ok
    [0 0   2 6*a  ]*x1 == [0 0   2 6*a  ]*x2; %#ok
    %continuity conditions at point b
    [1 b b^2   b^3]*x2 == [1 b b^2   b^3]*x3; %#ok
    [0 1 2*b 3*b^2]*x2 == [0 1 2*b 3*b^2]*x3; %#ok
    [0 0   2 6*b  ]*x2 == [0 0   2 6*b  ]*x3; %#ok
cvx_end
...
cvx_begin
    ...
    %continuity conditions at point a
    [1 a a^2   a^3]*xl1 == [1 a a^2   a^3]*xl2; %#ok
    [0 1 2*a 3*a^2]*xl1 == [0 1 2*a 3*a^2]*xl2; %#ok
    [0 0   2 6*a  ]*xl1 == [0 0   2 6*a  ]*xl2; %#ok
    %continuity conditions at point b
    [1 b b^2   b^3]*xl2 == [1 b b^2   b^3]*xl3; %#ok
    [0 1 2*b 3*b^2]*xl2 == [0 1 2*b 3*b^2]*xl3; %#ok
    [0 0   2 6*b  ]*xl2 == [0 0   2 6*b  ]*xl3; %#ok
cvx_end
