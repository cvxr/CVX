...
%   POLYENV( P, X ) produces the same result as POLYVAL( P, X ).
%
%   POLYENV looks at the first nonzero element of P (presumably, but not
...
%   proper convex/concave envelope exists. Therefore, POLYENV returns an
%   error in such cases.
%
...
%       expressions, X must be affine, unless the polynomial described by
%       P has a degree of 0 or 1. P must be constant.
