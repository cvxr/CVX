...
\title{\cvx Users' Guide\\\large for \cvx version 1.1 beta}
...
opinion. 
You need not worry that these ``extra'' variables will slow down
the solution of your models. 
In fact, in many cases, this
practice may \emph{improve} performance by exposing 
more of your problem's structure to the solver.
...
handles values other than \verb@1@, \verb@2@, and \verb@Inf@. Convex.
