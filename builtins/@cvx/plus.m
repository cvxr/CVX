...
%   expressions are both convex and concave, so they can be added to any
%   nonlinear expressions. Complex affine (or constant) expressions,
%   however, are neither, so they can only be added to other affine
...
%   Only log-convex terms may be summed; this includes positive constants,
%   monomials, posynomials, and generalized posynomials.
%
