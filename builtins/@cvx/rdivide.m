...
%   For DCP purposes, the RDIVIDE division operator X./Y is equivalent to
%   X.*(1./Y). The right-hand term must be constant and non-zero; and if the
%   left-hand term is nonlinear, this constant must also be real.
%
